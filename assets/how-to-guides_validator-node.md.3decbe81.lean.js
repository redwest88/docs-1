...
`),q])])]),x,s("table",null,[I,s("tbody",null,[s("tr",null,[P,V,s("td",null,o(t(n).mainnetChainId),1),s("td",null,[s("code",null,"--chain-id "+o(t(n).mainnetChainId),1)])]),s("tr",null,[D,R,s("td",null,o(t(n).mochaChainId),1),s("td",null,[s("code",null,"--chain-id "+o(t(n).mochaChainId),1)])]),s("tr",null,[N,L,s("td",null,o(t(n).arabicaChainId),1),s("td",null,[s("code",null,"--chain-id "+o(t(n).arabicaChainId),1)])])])]),O,s("div",M,[j,z,s("pre",W,[s("code",null,[U,a(`
`),Y,a(`
`),$,a(`
`),H,a(`
`),K,a(`
